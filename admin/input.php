              ...
              <div class="col-md-8">
                ...
                <div class="box box-warning">
                  ...
                  <div class="box-body">
                    ...
                    <form role="form" action="input_proses.php" method="get" enctype="multipart/form-data">
                      <!-- text input -->
                      <div class="form-group">
                        <label>Nama Wisata</label>
                        <input type="text" class="form-control" placeholder="Enter ..." name="nama_wisata">
                      </div>
                      <!-- textarea -->
                      <div class="form-group">
                        <label> Alamat</label>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="5" placeholder="Enter ..." name="deskripsi"></textarea>
                      </div>
                      <div class="form-group">
                       <label class="control-label">Tambahkan Foto</label>
                      <input id="uploadImage" type="file" name="fotoSatu"/>
                      </div>
                      <div class="form-group">
